...
class RepresentationsPathology():
    def __init__(self,
                ...
                lambda_inv=25.0,                    # Lambda weight for invariance term
                lambda_var=25.0,                    # Lambda weight for variance term
                lambda_cov=1.0,                     # Lambda weight for covariance term
    ...
    # Loss Function - VICReg
    def loss(self, rep_t1, rep_t2):
        loss = vicreg_loss(z_a=rep_t1, z_b=rep_t2, 
    ...
    def train(self, epochs, data_out_path, data, restore, print_epochs=10, n_images=25, checkpoint_every=None, report=False):
        ...
        losses = ['VICReg Loss Train', 'VICReg Loss Validation']
                ...
                for batch_images, batch_labels in data.training:
                    ...
                    if run_epochs % print_epochs == 0:
                        ...
                        for batch_images, batch_labels in data.validation:
                            ...
                            if self.wandb_flag: wandb.log({'VICReg Loss Train': epoch_outputs[0], 'VICReg Loss Validation': val_outputs[0],})
                            break
