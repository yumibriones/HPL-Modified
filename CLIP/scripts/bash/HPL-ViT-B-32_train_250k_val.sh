...
#SBATCH --job-name=HPL-ViT-B-32_train_250k_val
...
srun --cpu_bind=v --accel-bind=gn python -u src/open_clip_train/main.py \
    ...
    --val-data="/gpfs/home/yb2612/dl4med_25/dl_project/data/scratch_data/hpl-clip/lung_val_10k_filepath_caption.csv" \
    --csv-img-key filepath \
    --csv-caption-key caption \
    --csv-separator , \
    --logs /gpfs/home/yb2612/dl4med_25/dl_project/data/scratch_data/hpl-clip/logs \
    --warmup 2000 \
    --batch-size=256 \
    --lr=1e-3 \
    --wd=0.1 \
    ...
    --workers=4 \
    --model ViT-B-32 \
    --name "HPL-ViT-B-32_train_250k_val" \
    --seed 9 \
    --local-loss \
    --gather-with-grad